...
@section('contents')
<!-- tombol kembali -->
<a href="{{ route('home') }}" class="inline-block mt-4 mb-4 px-1 py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-600">
    ← Kembali ke Beranda
</a>
...
<div class="grid grid-cols-1 px-10 bg-purple-100 rounded-lg">
    ...
    <a href="{{ route('transcripts.download', $transcript->id) }}"
    ...
    <a href="{{ route('edit', ['id' => $transcript->id]) }}"
