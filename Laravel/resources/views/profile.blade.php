        ...
        <div class="w-1/5 bg-purple-200 h-screen p-7 flex flex-col justify-between">
            ...
            <div class="mt-auto relative">
                <div class="flex items-center cursor-pointer" onclick="toggleDropdown()">
                    <img src="{{ Auth::user()->fotoprofil ? asset(Auth::user()->fotoprofil) : asset('images/avatar.png') }}" alt="Gambar Default" class="w-10 h-10 rounded-full">
                    <div class="ml-2">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center mb-8">
                    ...
                    <div class="relative group">
                        <img src="{{ Auth::user()->fotoprofil ? asset(Auth::user()->fotoprofil) : asset('images/avatar.png') }}" alt="Foto Profil"
